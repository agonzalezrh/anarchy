...
<3> Each subject may include a list of parameters to pass to the _API_, though the governor and API get the final say in how and when the parameters are used.
